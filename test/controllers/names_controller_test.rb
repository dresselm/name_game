...
class NamesControllerTest < ActionController::TestCase
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post :create, name: { is_first_name: @name.is_first_name, is_middle_name: @name.is_middle_name, name: @name.name }
    end
  ...
  test "should update name" do
    patch :update, id: @name, name: { is_first_name: @name.is_first_name, is_middle_name: @name.is_middle_name, name: @name.name }
    assert_redirected_to name_path(assigns(:name))
  end
