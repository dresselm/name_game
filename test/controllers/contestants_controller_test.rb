...
class ContestantsControllerTest < ActionController::TestCase
  ...
  test "should create contestant" do
    assert_difference('Contestant.count') do
      post :create, contestant: { first_name_id: @contestant.first_name_id, middle_name_id: @contestant.middle_name_id }
    end
  ...
  test "should update contestant" do
    patch :update, id: @contestant, contestant: { first_name_id: @contestant.first_name_id, middle_name_id: @contestant.middle_name_id }
    assert_redirected_to contestant_path(assigns(:contestant))
  end
